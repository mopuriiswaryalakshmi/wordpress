...
jQuery(function($){
  ////////////////////////////////
      ...
      jQuery(document).on('click', 'input.select-img', function( event ){
        ...
        var MedicalWayImage = wp.media.controller.Library.extend({
            defaults :  _.defaults({
        ...
        medical_way_file_frame = wp.media.frames.medical_way_file_frame = wp.media({
          button: {
        ...
        medical_way_file_frame.on( 'select', function() {

          var state = medical_way_file_frame.state('rtam-insert-image');
